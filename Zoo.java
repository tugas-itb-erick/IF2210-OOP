  ...
  public void Read(Scanner in){
    ...
    for(int i=0; i<r; i++){
      for(int j=0; j<c; j++){
        ...
        Place p = Place.PLACE_NONE;
        switch (k){
          case 'W' : p = Place.WATERHABITAT; break;
          case 'A' : p = Place.AIRHABITAT; break;
          case 'L' : p = Place.LANDHABITAT; break;
          case '*' : p = Place.PARK; break;
          case 'R' : p = Place.RESTAURANT; break;
          case '-' : p = Place.ROAD; break;
          case 'i' : p = Place.ENTRANCE; break;
          case 'o' : p = Place.EXIT; break;
        }
        cell[i][j] = new Cell(p, k);
      }
    }
  }
  /**
