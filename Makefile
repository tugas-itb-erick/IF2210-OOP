bin/main: bin/obj/zoo/Zoo.o bin/obj/zoo/zoo_driver.o bin/obj/driver/driver.o bin/obj/main.o bin/obj/renders/cell.o bin/obj/renders/cage/cage.o bin/obj/renders/renderable.o bin/obj/renders/animals/flying_animal.o bin/obj/renders/animals/diet/omnivore.o bin/obj/renders/animals/diet/herbivore.o bin/obj/renders/animals/diet/carnivore.o bin/obj/renders/animals/species.o bin/obj/renders/animals/taxonomy/aves.o bin/obj/renders/animals/taxonomy/amphibia.o bin/obj/renders/animals/taxonomy/pisces.o bin/obj/renders/animals/taxonomy/reptilia.o bin/obj/renders/animals/taxonomy/vertebrate.o bin/obj/renders/animals/taxonomy/mammalia.o bin/obj/renders/animals/water_animal.o bin/obj/renders/animals/land_animal.o bin/obj/renders/animals/animal.o bin/obj/renders/habitats/air_habitat.o bin/obj/renders/habitats/habitat.o bin/obj/renders/habitats/land_habitat.o bin/obj/renders/habitats/water_habitat.o bin/obj/renders/facilities/restaurant/restaurant.o bin/obj/renders/facilities/facility.o bin/obj/renders/facilities/park/park.o bin/obj/renders/facilities/road/entrance/entrance.o bin/obj/renders/facilities/road/road.o bin/obj/renders/facilities/road/exit/exit.o bin/obj/other/color.o
	@echo "Linking ..."
	@g++ bin/obj/zoo/Zoo.o bin/obj/zoo/zoo_driver.o bin/obj/driver/driver.o bin/obj/main.o bin/obj/renders/cell.o bin/obj/renders/cage/cage.o bin/obj/renders/renderable.o bin/obj/renders/animals/flying_animal.o bin/obj/renders/animals/diet/omnivore.o bin/obj/renders/animals/diet/herbivore.o bin/obj/renders/animals/diet/carnivore.o bin/obj/renders/animals/species.o bin/obj/renders/animals/taxonomy/aves.o bin/obj/renders/animals/taxonomy/amphibia.o bin/obj/renders/animals/taxonomy/pisces.o bin/obj/renders/animals/taxonomy/reptilia.o bin/obj/renders/animals/taxonomy/vertebrate.o bin/obj/renders/animals/taxonomy/mammalia.o bin/obj/renders/animals/water_animal.o bin/obj/renders/animals/land_animal.o bin/obj/renders/animals/animal.o bin/obj/renders/habitats/air_habitat.o bin/obj/renders/habitats/habitat.o bin/obj/renders/habitats/land_habitat.o bin/obj/renders/habitats/water_habitat.o bin/obj/renders/facilities/restaurant/restaurant.o bin/obj/renders/facilities/facility.o bin/obj/renders/facilities/park/park.o bin/obj/renders/facilities/road/entrance/entrance.o bin/obj/renders/facilities/road/road.o bin/obj/renders/facilities/road/exit/exit.o bin/obj/other/color.o -o bin/main
...
bin/obj/renders/animals/flying_animal.o: src/renders/animals/flying_animal.cpp src/renders/animals/flying_animal.h
	@echo "Compiling renders/animals/flying_animal.cpp ..."
	@g++ -c src/renders/animals/flying_animal.cpp -o bin/obj/renders/animals/flying_animal.o -std=c++11
...
bin/obj/renders/animals/water_animal.o: src/renders/animals/water_animal.cpp src/renders/animals/water_animal.h
	@echo "Compiling renders/animals/water_animal.cpp ..."
	@g++ -c src/renders/animals/water_animal.cpp -o bin/obj/renders/animals/water_animal.o -std=c++11

bin/obj/renders/animals/land_animal.o: src/renders/animals/land_animal.cpp src/renders/animals/land_animal.h
	@echo "Compiling renders/animals/land_animal.cpp ..."
	@g++ -c src/renders/animals/land_animal.cpp -o bin/obj/renders/animals/land_animal.o -std=c++11
...
bin/obj/renders/habitats/air_habitat.o: src/renders/habitats/air_habitat.cpp src/renders/habitats/air_habitat.h
	@echo "Compiling renders/habitats/air_habitat.cpp ..."
	@g++ -c src/renders/habitats/air_habitat.cpp -o bin/obj/renders/habitats/air_habitat.o -std=c++11
...
bin/obj/renders/habitats/land_habitat.o: src/renders/habitats/land_habitat.cpp src/renders/habitats/land_habitat.h
	@echo "Compiling renders/habitats/land_habitat.cpp ..."
	@g++ -c src/renders/habitats/land_habitat.cpp -o bin/obj/renders/habitats/land_habitat.o -std=c++11

bin/obj/renders/habitats/water_habitat.o: src/renders/habitats/water_habitat.cpp src/renders/habitats/water_habitat.h
	@echo "Compiling renders/habitats/water_habitat.cpp ..."
	@g++ -c src/renders/habitats/water_habitat.cpp -o bin/obj/renders/habitats/water_habitat.o -std=c++11
