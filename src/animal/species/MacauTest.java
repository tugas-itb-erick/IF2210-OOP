...
public class MacauTest {
	Macau test = new Macau("Test", 1000, Sex.MALE, 1, 2);
	...
	public void testGetFirstHabitat() {
		assertTrue(test.getFirstHabitat() == 'A');
	}

	@Test
	public void testGetSecondHabitat() {
		assertTrue(test.getSecondHabitat() == 'A');
	}
