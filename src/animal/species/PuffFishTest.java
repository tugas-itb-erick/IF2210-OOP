...
public class PuffFishTest {
	PuffFish test = new PuffFish("Test", 1000, Sex.MALE, 1, 2);
	...
	public void testGetFirstHabitat() {
		assertTrue(test.getFirstHabitat() == 'W');
	}

	@Test
	public void testGetSecondHabitat() {
		assertTrue(test.getSecondHabitat() == 'W');
	}
	...
	public void testRender() {
		assertTrue(test.render() == 'F');
	}

	@Test
	public void testGetHeartChamber() {
		assertTrue(test.getHeartChamber() == 2);
	}

	@Test
	public void testGetBloodTemperature() {
		assertTrue(test.getBloodTemperature() == 'c');
	}
