...
public class Cendrawasih extends Animal implements FlyingAnimal, Omnivore, Aves {
  /**
   * Constructor.
   */
  public Cendrawasih() {
   ...
   */
  public Cendrawasih(String parName, double parWeight, Sex parSex, int parRow, int parCol) {
