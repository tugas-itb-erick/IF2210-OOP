...
public class Cage implements Renderable {
  ...
  */
  ...
  /**
   * Memeriksa apakah ada binatang dengan species parSpecies pada cage.
   * @return true jika ada binatang dengan species parSpecies, false jika tidak ada
   */
  public boolean searchAnimal(Animal parSpecies) {
    int i = 0;
    boolean found = false;
  ...
  */
  public void addAnimal(Animal in) {
    if (!isFull() && ((in.getFirstHabitat() == getHabitat()) 
      ...
      if (!searchAnimal(in.getRow(), in.getCol())) { // no other animal in the target coordinate
        if (isWild()) {
          if (in.isWild()) {
  ...
  /**
  * Mengembalikan jenis habitat kandang (format lower case) untuk 
  ...
  */
  ...
  /**
  * Mengembalikan jenis habitat kandang (format lower case) dengan 
  * kode warna untuk ditampilkan pada layar.
  * @return kode warna beserta kode habitat
  */
  @Override
  ...
  */
  ...
  /**
  * Mengembalikan jumlah total daging yang dikonsumsi seluruh binatang
  * pada kandang.
  ...
  */
  ...
  /**
  * Mengembalikan jumlah total sayur yang dikonsumsi seluruh binatang 
  * pada kandang.
  * @return jumlah daging
  */
